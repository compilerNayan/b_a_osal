#ifndef AWS_IOT_CORE_CONFIG_PROVIDER_INTERNAL_H
#define AWS_IOT_CORE_CONFIG_PROVIDER_INTERNAL_H
...
-----END RSA PRIVATE KEY-----
    ...
    Public Virtual StdString GetSendTopic() const override {
        return "nknk32/pub";
    }

    Public Virtual StdString GetReceiveTopic() const override {
        return "nknk32/sub";
    }
};


#endif // AWS_IOT_CORE_CONFIG_PROVIDER_INTERNAL_H