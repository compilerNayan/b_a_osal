...
#ifndef ESPIDF_THREAD_POOL_INTERNAL_H
#define ESPIDF_THREAD_POOL_INTERNAL_H
...
#include "../../02-interface/02-IThreadPool.h"
#include "../../02-interface/01-IRunnable.h"
 ...
 */
/* @Component */
class EspidfThreadPool final : public IThreadPool {

    struct ExecuteParam {
        EspidfThreadPool* self;
...
Public
    ...
    Explicit EspidfThreadPool(CSize /* numThreads */)
        : EspidfThreadPool() {}

    ~EspidfThreadPool() override {
...
#endif // ESPIDF_THREAD_POOL_INTERNAL_H
#endif // ESP_PLATFORM
